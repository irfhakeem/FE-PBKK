...
<template>
  <nav
    class="fixed top-0 w-full border-b-[1.5px] border-[#191919] flex items-center justify-center py-5"
  >
    <div
      class="flex justify-between items-center w-full lg:max-w-6xl mx-auto px-4"
    >
      <div>
        <a href="/">
          <svg
      ...
      <div class="flex gap-5 text-sm items-center">
        ...
        <a
          href="/register"
          class="bg-[#191919] hover:bg-black rounded-full text-white py-[0.6rem] font-medium md:text-sm text-xs mx-auto px-4"
        >
          Get started
        </a>
      </div>
  ...
  <div
    class="flex flex-col items-center justify-center h-screen w-screen bg-gradient-to-b from-amber-500 via-[#ffd723] to-stone-100 animate-gradient"
  >
    <div class="flex flex-col gap-14 max-w-3xl text-center md:p-0 p-5">
      <p class="lg:text-8xl md:text-7xl text-5xl font-medium">
        Be part of a <br />
        <span class="font-bold">better internet</span>
      </p>
      <p class="lg:text-2xl sm:text-xl text-base">
        Read. Write. Deepen your understanding. <br />
  ...
  <footer
    class="fixed bottom-0 w-full py-5 px-5 border-t-[1.5px] border-[#191919] flex items-center lg:justify-center justify-start"
  >
    <!-- <Footer custom="sm:flex hidden text-black text-xs gap-3" /> -->
    <div class="flex sm:hidden text-black text-xs gap-3"></div>
  </footer>
</template>
